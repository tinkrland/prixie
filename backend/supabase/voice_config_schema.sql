...
-- format: {"fist_score": 0.8, "cadence_wpm": 150, "prosody": 0.3, "tone": "formal",
...
INSERT INTO public.voice_presets (name, description, fist_score, fist_timing_variation, fist_rhythm_stability, fist_pause_pattern, fist_startup_pattern, fist_turn_entry_pattern, cadence_wpm, prosody, tone, is_builtin)
VALUES
    ('default', 'general purpose — clean, neutral', 0.7, 0.35, 0.72, 'deliberate', 'brief_pause', 'beat', 140, 0.4, 'neutral', TRUE),
    ('warm', 'community and social contexts', 0.65, 0.4, 0.68, 'natural', 'brief_pause', 'filler', 130, 0.6, 'warm', TRUE),
    ('professional', 'client and enterprise meetings', 0.85, 0.25, 0.82, 'deliberate', 'brief_pause', 'beat', 150, 0.2, 'formal', TRUE),
    ('casual', 'internal team and hackathon', 0.55, 0.45, 0.6, 'natural', 'immediate', 'filler', 160, 0.7, 'casual', TRUE),
    ('curious', 'learning and discovery', 0.6, 0.38, 0.65, 'deliberate', 'brief_pause', 'beat', 135, 0.5, 'curious', TRUE),
    ('assertive', 'negotiation and sales', 0.8, 0.28, 0.78, 'deliberate', 'brief_pause', 'beat', 160, 0.3, 'assertive', TRUE),
    ('steady', 'technical and precise — highest fist score', 0.95, 0.15, 0.92, 'deliberate', 'deliberate_opening', 'deliberate', 145, 0.15, 'neutral', TRUE),
    ('erratic', 'deliberately unpredictable — lowest fist score', 0.2, 0.7, 0.25, 'natural', 'immediate', 'immediate', 155, 0.8, 'casual', TRUE)
